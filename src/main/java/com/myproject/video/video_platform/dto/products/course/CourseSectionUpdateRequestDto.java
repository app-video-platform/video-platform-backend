...
@Data
@Schema(description = "Command to update existing course section details.")
public class CourseSectionUpdateRequestDto {
    ...
    @NotBlank
    @Schema(description = "Owning course identifier", example = "a8c5d4a9-dc93-4c71-9c33-5d56f3d6b21d")
