...
public record ProductMinimised(
        ...
        @Schema(description = "Pricing model", example = "ONE_TIME") String pricingModel,
        @Schema(description = "Recurring interval", example = "MONTH", nullable = true) String billingInterval,
        @Schema(description = "Currency", example = "EUR") String currency,
